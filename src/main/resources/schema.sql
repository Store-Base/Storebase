...
ALTER TABLE cliente ADD COLUMN IF NOT EXISTS ativo BOOLEAN DEFAULT TRUE;
...
ALTER TABLE produto ADD COLUMN IF NOT EXISTS icms DECIMAL(5,2);
ALTER TABLE produto ADD COLUMN IF NOT EXISTS ipi DECIMAL(5,2);
ALTER TABLE produto ADD COLUMN IF NOT EXISTS pis DECIMAL(5,2);
ALTER TABLE produto ADD COLUMN IF NOT EXISTS cofins DECIMAL(5,2);
ALTER TABLE produto ADD COLUMN IF NOT EXISTS ncm VARCHAR(20);
ALTER TABLE produto ADD COLUMN IF NOT EXISTS cfop VARCHAR(10);
ALTER TABLE produto ADD COLUMN IF NOT EXISTS cst VARCHAR(5);
